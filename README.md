<picture>
  ...
  <img alt="Daniel — self-hosting, home automation, network privacy" src="assets/banner-light.svg">
</picture>
...
<sub>The header is a plain SVG generated by <a href="generate_banner.py"><code>generate_banner.py</code></a>
and committed to this repo — no external service, nothing to rate-limit, adapts to your GitHub theme.</sub>
